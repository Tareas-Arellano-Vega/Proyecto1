...
const FormularioMedico = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError('')
      // Aquí puedes manejar la respuesta del servidor, por ejemplo, mostrar un mensaje de éxito o redirigir a otra página
    } catch (error) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Agrega aquí los demás campos del formulario siguiendo la misma estructura */}
